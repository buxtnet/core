...
namespace Buxt\Navigation;

use Exception; // Sử dụng Exception tiêu chuẩn thay thế
use Buxt\Navigation\MenuBuilder;
...
class Navi
{
    ...
    {
        if ($this->menu) {
            throw new Exception('Classes must be set before building the menu.');
        }
